...
--  },
--  config = function()
--    --vim.keymap.set('n', '<leader>n', ':Neotree filesystem toggle reveal_file=%:p position=left<CR>', {})
--    vim.keymap.set('n', '<leader>n', ':Neotree toggle position=left reveal_file=%:p<CR>', {})
--  end
--}
return {
